      ...
      <div className="relative grid">
        <select
          ...
          className={cn(
            ...
            "flex gap-2 px-2.5 pb-2.5 pt-4 w-full text-sm   bg-transparent rounded-lg border-2  appearance-none  focus:outline-none focus:ring-0  peer "
          )}
          placeholder=""
          {...register(name)}
          {...rest}
        >
          ...
          {options?.map((option: any, index: number) => (
            <option
              ...
              value={option.value}
              className="capitalize pt-2 text-black"
            >
              {option.label}
            </option>
          ))}
